...
export const autoClearQueue = async (event: any): Promise<BackgroundProcessResults> => {
  ...
  const adminBiketagOpts = getBikeTagAdminOpts(event, true, true, game)
...
const autoPostClearHandler = async (event: any) => {
...
export { autoPostClearHandler as handler }
